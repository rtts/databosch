...
class Program(models.Model):
    ...
    sublocation = models.ForeignKey(SubLocation, blank=True, null=True, related_name='+', on_delete=models.PROTECT, help_text='Kies eerst een locatie voordat je hier een sublocatie kunt kiezen')
