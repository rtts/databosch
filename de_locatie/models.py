...
class Partnership(NumberedModel):
    ...
    partner = models.ForeignKey(Entiteit, related_name='+')
...
class Project(models.Model):
    ...
    tags = models.ManyToManyField('Tag', blank=True)
    content = RichTextField('inhoud', blank=True)
    entity = models.ForeignKey(Entiteit, verbose_name='bestaande entiteit', help_text='Kies hier de DataBosch entiteit die dit project vertegenwoordigt', blank=True, null=True, related_name='+')
